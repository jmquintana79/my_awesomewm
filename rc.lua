...
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, " ram: $1%($2/$3MB) ", 13)
...
vicious.register(netwidget, vicious.widgets.net,
                    function (widget, args)
                        netwidget_t:set_text("net: " .. args["{wlan0 down_kb}"] .. "kb/s")
...
myawesomemenu = {
   ...
   { "edit config", terminal .. " -e /opt/sublime_text/sublime_text " .. awesome.conffile }, 
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    { "chrome", terminal .. " -e /opt/google/chrome/google-chrome &" },
                                    { "sublime", terminal .. " -e /opt/sublime_text/sublime_text"},
                                    { "nautilus", "nautilus"}
                                  }
                        })
